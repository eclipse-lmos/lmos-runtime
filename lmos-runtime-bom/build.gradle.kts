...
dependencies {
    ...
    val lmosRouterVersion = "0.28.0"
    val arcVersion = "0.229.0"
    val langChain4jVersion = "1.16.1"
    val kotlinCoroutines = "1.11.0"
    ...
    constraints {
        ...
        api("com.expediagroup:graphql-kotlin-spring-server:10.0.0")
