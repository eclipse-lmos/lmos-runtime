...
//
//    // Converted the inner WindowsCredential class into a data class.
...
//    data class WindowsCredential(val target: String?, val username: String?, val password: String)
//
//    // Retrieves a credential for the specified target from Windows WindowsCredential Manager.
//    fun getCredential(target: String): WindowsCredential {
...
//                return WindowsCredential(credMem.TargetName, credMem.UserName, password)
//            } else {
...
//    }
//
//    // Sets a credential in the Windows WindowsCredential Manager.
...
//    }
//
//    // Deletes a credential from the Windows WindowsCredential Manager.
//    @Throws(UnsupportedEncodingException::class)
